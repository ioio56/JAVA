...
public class PlayMap {
	...
	public static void main(String[] args) {
		...
		// playMap에 key 값은 노래제목, value값은 가수명이 되도록
		// 데이터들을 담아보세요
		...
		// 검색
		searchSong("제목", "사랑", playMap);
		searchSong("가수", "아이유", playMap);
	...
	public static void searchSong(String option, String keyword, HashMap<String, String> playMap) {
		...
		for (String key : keySet) {
			if (option.equals("제목")) {
				// Key 값중에 Keyword를 포함하고 있는 데이터 체크
